      ...
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          ...
          <div className="text-left ">
            <h4 className="text-lg text-white font-medium mb-7">Menüü</h4>
            <Link to="/#concerts">
              <div className="basis-3/7 flex-none">Kontserdid</div>
            </Link>
            <Link to="/#music">
              <div className="basis-3/7 flex-none">Muusika</div>
            </Link>
            <Link to="/#about-us">
              <div className="basis-1/3 flex-none">Meist</div>
            </Link>
            <Link to="/#contact-form">
              <div className="basis-1/3 flex-none">Kontakt</div>
            </Link>
            <Link to="/demos">
              <div className="basis-1/3 flex-none">Demod</div>
            </Link>
          </div>
          ...
          <div className="flex flex-nowrap items-center">
            <div className="flex flex-col items-center mr-4">
              ...
              <svg
                className="w-10 h-10 lg:w-12 lg:h-12 text-gray-800 dark:text-white"
                aria-hidden="true"
          ...
          <div>
            <h4 className="text-lg text-white font-medium mb-7 text-center">
              Jälgi meid
            </h4>
            <div className="flex flex-col items-center">
              <div className="flex space-x-6 mb-4">
                ...
                >
                  <svg
                    ...
                    viewBox="0 0 49 21"
                    fill="currentColor"
                    className="w-10 h-10 transition duration-300 hover:text-red-700"
                    xmlns="http://www.w3.org/2000/svg"
                  >
