      ...
      <div className="flex flex-col items-center mt-4 pb-6">
        <div className="flex space-x-6 mb-4">
          <Link
            ...
            aria-label="Kuula meid SoundCloudis"
          >
            <svg
              role="img"
              width={49}
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Kuula meid Spotyfist"
          >
            <svg
              role="img"
              width={45}
        ...
        <div className="flex space-x-6">
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Vaata meie pilte Instagramist"
          >
            <svg
              role="img"
              width={53}
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Jälgi meie tegevusi Facebookis"
          >
            <svg
              role="img"
              width={43}
          ...
          <Link
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Kuula meid Youtubest"
          >
            <svg
              role="img"
              width={44}
